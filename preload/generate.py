...
W('int scandir(const char *dir, struct dirent ***namelist, SCANDIR_TYPE_ARG3, int(*compar)(const struct dirent **, const struct dirent **))', b_map("dir"), argnames=['dir','namelist','filter','compar'])
W('int scandir64(const char *dir, struct dirent64 ***namelist, int(*filter)(const struct dirent64 *), int(*compar)(const struct dirent64 **, const struct dirent64 **))', b_map("dir"),argnames=['dir','namelist','filter','compar'])
